...
async function getTencentAPIInstance(sdk) {
  ...
  if (!tencentAPI || sdk.context.refresh) {
    ...
    } else if (process.env.TENCENT_SECRET_ID_PLATFORM && process.env.TENCENT_SECRET_KEY_PLATFORM) {
      SecretId = process.env.TENCENT_SECRET_ID_PLATFORM;
      SecretKey = process.env.TENCENT_SECRET_KEY_PLATFORM;
    }
